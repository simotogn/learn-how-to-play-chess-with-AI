...
def modifica_board(board,mossa,colore,l):
    ...
    if(len(mossa) == 3):
        ...
        if(pezzo == "C"):                                                                           #mossa cavallo
            if(colore == "b"):
                pos_cav = posizioni_valide_cavalli(board,l)[0]
                x = i*5+j
                for key in pos_cav:
                ...
                pos_cav = posizioni_valide_cavalli(board,l)[1]
                x = i*5+j
                for key in pos_cav:
                    for elem in pos_cav[key]:
                        if (elem == x):
            ...
            if(colore == "b"):
                pos_alf = posizioni_valide_alfieri(board,l)[0]
                x = i*5+j
                for key in pos_alf:
                ...
                pos_alf = posizioni_valide_alfieri(board,l)[1]
                x = i*5+j
                for key in pos_alf:
                    for elem in pos_alf[key]:
                        if (elem == x):
            ...
            if(colore == "b"):
                pos_tow = posizioni_valide_torri(board,l)[0]
                x = i*5+j
                for key in pos_tow:
                ...
                pos_tow = posizioni_valide_torri(board,l)[1]
                x = i*5+j
                for key in pos_tow:
                    for elem in pos_tow[key]:
                        if (elem == x):
            ...
            if(colore == "b"):
                pos_queen = posizioni_valide_regina(board,l)[0]
                x = i*5+j
                ...
                pos_queen = posizioni_valide_regina(board,l)[1]
                x = i*5+j
                for key in pos_queen:
                    for elem in pos_queen[key]:
                        if (elem == x):
            ...
            if(colore == "b"):
                pos_re = posizioni_valide_re(board,l)[0]
                x = i*5+j
                for key in pos_re:
                ...
                pos_re = posizioni_valide_re(board,l)[1]
                x = i*5+j
                for key in pos_re:
                    for elem in pos_re[key]:
                        if (elem == x):
        ...
        if(i<0 or i>4 or j<0 or j>4):
            ...
            return -1
        if(colore == "b"):
            pos_pedoni = posizioni_valide_pedoni(board,l)[0]
            x = i*5+j
            ...
            pos_pedoni = posizioni_valide_pedoni(board,l)[1]
            x = i*5+j
            for key in pos_pedoni:
                for elem in pos_pedoni[key]:
                    if (elem == x):
