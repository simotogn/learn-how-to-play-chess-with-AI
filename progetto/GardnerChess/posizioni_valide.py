    ...
    for i in range(l):
        for j in range(l):
            if ( mat[i][j] == "bP" ):                                           #pedoni bianchi
                ...
                if (j==4):                                                      #controllo diagonali sinistre per pedoni sul bordo dx
                    if(i+1<l and mat[i+1][j-1] != "" and mat[i+1][j-1][0] == "n"):
                        diz_b[(i,j)].append((i+1)*l+(j-1))                                                    
                ...
                if (i==4 and mat[i-2][j] == "" and mat[i-1][j] == ""):          #controllo la casella due righe sotto solo se il pedone non si è mai mosso
                ...
                if (j==4):                                                      #controllo diagonali sinistre per pedoni sul bordo dx
                    if(i-1>=0 and mat[i-1][j-1] != "" and mat[i-1][j-1][0] == "b"):
                        diz_n[(i,j)].append((i-1)*l+(j-1))                                                    
                if (j>0 and j<4):                                               #controllo diagonali per pedoni centrali                                                      
                    if(i-1>=0 and mat[i-1][j+1] != "" and mat[i-1][j+1][0] == "b"):
                        diz_n[(i,j)].append((i-1)*l+(j+1))
                    if(i-1>=0 and mat[i-1][j-1] != "" and mat[i-1][j-1][0] == "b"):
                        diz_n[(i,j)].append((i-1)*l+(j-1)) 
            ...
            if(mat[i][j] == "bT"):
                ...
                while(k<l):                                                             #controllo riga superiore                                      
                    if(mat[k][j] == ""):
                        ...
                        break
                if (j!=4):                                                               #controllo riga laterale dx 
                    ld = j+1
                    while(ld!=4):                                                                                                  
                        if(mat[i][ld] == ""):
                            ...
                            break
                    if(ld==4 and (mat[i][ld] == "" or mat[i][ld][0] == "n")):
                        diz_b[(i,j)].append(i*l+ld)
                ...
                if (j!=4):                                                               #controllo riga laterale dx 
                    ...
                    while(ld!=4):                                                                                                  
                        if(mat[i][ld] == ""):
                            ...
                            break
                    if(ld==4 and (mat[i][ld] == "" or mat[i][ld][0] == "b")):
                        diz_n[(i,j)].append(i*l+ld)
                if (j!=0):                                                   #controllo riga laterale sx
                    ls = j-1
                    while(ls!=0):                                                                                                 
